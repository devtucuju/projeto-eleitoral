...
export default function Security() {
  ...
  return (
    <div className="mb-6 rounded-2xl border border-gray-200 bg-white p-5 lg:p-6 dark:border-gray-800 dark:bg-white/[0.03]">
      <h4 className="text-lg font-semibold mb-4 text-gray-800 lg:mb-6 dark:text-white/90">
        Security
      </h4>
      <div>
        <div className="flex flex-col justify-between gap-4 border-b border-gray-200 py-4 first:pt-0 last:border-b-0 last:pb-0 sm:flex-row sm:items-end dark:border-gray-800">
          <div>
            <span className="block font-medium mb-1 text-base text-gray-800 dark:text-white/90">
              Change Password
            </span>
        ...
        <div className="flex flex-col justify-between gap-4 border-b border-gray-200 py-4 first:pt-0 last:border-b-0 last:pb-0 sm:flex-row sm:items-end dark:border-gray-800">
          <div>
            <span className="block font-medium text-base text-gray-800 dark:text-white/90">
