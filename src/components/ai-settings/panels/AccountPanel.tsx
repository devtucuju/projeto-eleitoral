      ...
      <SettingsSection title="Profile Info">
        <SettingsCard>
          <div className="flex items-center gap-3 border-b border-gray-100 p-4 dark:border-gray-800">
            ...
            <div>
              <label className="mb-2 inline-flex h-7 cursor-pointer items-center justify-center rounded-lg border border-gray-300 px-3 py-1 text-sm font-medium text-gray-700 shadow-xs hover:bg-gray-100 dark:border-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white/90">
