                ...
                <div className="flex items-center gap-1">
                  ...
                  <div className="relative" ref={dropdownRef}>
                    <button
                      ...
                      className="flex size-9 items-center justify-center gap-1.5 rounded-lg border border-gray-100 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-300"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
