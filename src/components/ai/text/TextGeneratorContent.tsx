    ...
    <div className="custom-scrollbar relative z-20 max-h-[50vh] flex-1 mx-auto space-y-7 w-full overflow-y-auto pb-16">
      ...
      <div className="flex justify-start">
        <div>
          ...
          <div className="relative inline-flex mt-3">
            <Tooltip content={copiedAI ? "Copied!" : "Copy"} {...TOOLTIP}>
              <button onClick={handleCopyAI} className={BTN_CLASS}>
                {copiedAI ? (
            ...
            <Tooltip content="Like" {...TOOLTIP}>
              <button onClick={handleLike} className={REACTION_BTN_CLASS}>
                <LikeIcon
                  className={`${REACTION_ICON_CLASS} ${liked ? "text-brand-500" : "text-gray-800 dark:text-gray-400"}`}
                />
              </button>
            </Tooltip>
            <Tooltip content="Dislike" {...TOOLTIP}>
              <button onClick={handleDislike} className={REACTION_BTN_CLASS}>
                <DislikeIcon
                  className={`${REACTION_ICON_CLASS} ${disliked ? "text-brand-500" : "text-gray-800 dark:text-gray-400"}`}
                />
              </button>
            </Tooltip>
      ...
      <div className="flex justify-start">
        <div>
          ...
          <div className="relative inline-flex mt-3">
            <Tooltip content={copiedAI2 ? "Copied!" : "Copy"} {...TOOLTIP}>
