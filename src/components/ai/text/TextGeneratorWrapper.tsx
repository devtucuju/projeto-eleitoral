...
const menuItemClass = (active: boolean) =>
  `${MENU_ITEM_BASE} ${active ? "bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-white" : "text-gray-700 dark:text-gray-400"}`;
              ...
              <div className="flex items-center justify-between pt-2">
                <div className="flex items-center gap-1">
                  ...
                  {selected !== "" && (
                    <button
                      onClick={() => setSelected("")}
                      className="text-brand-500 group hover:bg-brand-500/10 flex justify-center h-9 items-center gap-2 rounded-lg px-2.5 py-2 text-sm font-medium"
                    >
                      <span className="bg-brand-500/20 relative hidden size-6 shrink-0 items-center justify-center rounded-full group-hover:flex">
                        <CloseIcon />
                      </span>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="relative" ref={modelDropdownRef}>
                    <button
                      ...
                      className="flex items-center h-9 gap-1.5 text-sm px-2.5 rounded-lg py-2.5 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400"
                    >
                      {currentModel?.icon}
