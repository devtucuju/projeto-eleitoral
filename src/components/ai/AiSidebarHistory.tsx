      ...
      <li className="group relative rounded-full px-3 py-1.5 hover:bg-gray-50 dark:hover:bg-gray-950">
        <div className="flex cursor-pointer items-center justify-between">
          ...
          <button
            ...
            className="dropdown-trigger invisible ml-2 rounded-full p-1 text-gray-700 group-hover:visible hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-400"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="18"
        ...
        {isOpen && (
          <ul
            onMouseDown={(e) => e.stopPropagation()}
            className="dropdown-menu absolute right-0 z-20 mt-1 w-45 space-y-0.5 rounded-xl bg-white p-1.5 shadow-md dark:bg-gray-800"
          >
            {/* Star / Unstar */}
            <li>
              <button
