...
export default function ShareModal({ isOpen, onClose }: ShareModalProps) {
  ...
  return (
    <Modal
      ...
      className="w-[calc(100%-32px)]! max-w-[520px] p-6 mx-4 sm:mx-auto"
    >
      <div className="relative flex flex-col gap-4 sm:gap-6">
        ...
        <div>
          ...
          <div className="flex h-11 items-center rounded-lg border border-gray-300 px-4 py-3 text-sm whitespace-nowrap text-gray-800 shadow-xs dark:border-gray-800 dark:text-white/90 overflow-hidden">
            {SHARE_LINK}
          </div>
        </div>
