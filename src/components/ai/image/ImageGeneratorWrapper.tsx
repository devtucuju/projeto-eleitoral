  ...
  return (
    <div>
      <div className="flex items-center gap-1.5 border-b border-gray-100 px-2 py-2 dark:border-gray-800">
        <button
          onClick={onBack}
          className="flex items-center justify-center rounded-lg size-7 text-gray-500 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-800"
        >
              ...
              <div className="flex items-center justify-between pt-2">
                <div className="flex items-center gap-2">
                  <Tooltip content="Attachment" placement="top" variant="light">
                    <label className="flex size-9 dark:hover:bg-gray-900 cursor-pointer items-center justify-center gap-1.5 rounded-lg border border-gray-200 text-sm text-gray-500 hover:text-gray-700 dark:border-gray-700 dark:text-gray-400 dark:hover:text-gray-300">
                    ...
                    <div className="relative" ref={aspectRatioRef}>
                      <Tooltip content="Aspect" placement="top" variant="light">
                        <button
                          ...
                          aria-expanded={open}
                          className="flex cursor-pointer h-9 items-center dark:hover:bg-gray-900 justify-center gap-1.5 rounded-lg border border-gray-200 py-2 pr-3 pl-2.5 text-sm text-gray-500 hover:text-gray-700 dark:border-gray-700 dark:text-gray-400 dark:hover:text-gray-300"
                        >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="relative" ref={modelDropdownRef}>
                    <button
                      ...
                      className="flex items-center px-2.5 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-900 gap-1.5 text-sm text-gray-700 dark:text-gray-400"
                    >
                      {currentModel?.icon}
