...
const SEEDREAM_ICON = (
  <img src="/images/model/seedream.svg" width="18" height="18" alt="Seedream" />
);
              ...
              <div className="flex items-center justify-between pt-2">
                <div className="flex items-center gap-2">
                  <Tooltip content="Attachment" placement="top" variant="light">
                    <label className="flex size-9 cursor-pointer items-center dark:hover:bg-gray-900  justify-center gap-1.5 rounded-lg border border-gray-200 text-sm text-gray-500 hover:text-gray-700 dark:border-gray-700 dark:text-gray-400 dark:hover:text-gray-300">
                  ...
                  >
                    <button
                      ...
                      className="flex size-9 cursor-pointer items-center dark:hover:bg-gray-900 justify-center gap-1.5 rounded-lg border border-gray-200 text-sm text-gray-500 hover:bg-gray-100 hover:text-gray-700 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 "
                    >
                          ...
                          <div>
                            ...
                            <div className="flex w-full items-center justify-between gap-2 rounded-lg px-3.5 py-3">
                              ...
                              <label className="relative inline-flex cursor-pointer items-center">
                                ...
                                />
                                <div className="peer h-5 w-9 rounded-full bg-gray-200  after:absolute after:left-[2px] after:top-[2px] after:h-4 after:w-4 after:rounded-full after:bg-white after:transition-all after:content-[''] peer-checked:bg-brand-500 peer-checked:after:translate-x-full " />
                              </label>
                            </div>
                          </div>
                        )}
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="relative" ref={modelDropdownRef}>
                    <button
                      ...
                      className="flex items-center gap-1.5 text-sm  py-2 px-2.5 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-900 h-9 text-gray-700 dark:text-gray-400"
                    >
                      {currentModel?.icon}
