...
import type { TabId } from "@/components/ai-settings";
  ...
  return (
    <>
      <div className="relative overflow-hidden bg-white p-5 xl:flex xl:h-[calc(100vh-76px)] xl:p-0 dark:border-gray-800 dark:bg-gray-900">
        <div className="mt-4 flex items-center justify-between rounded-2xl border border-gray-200 bg-white p-3 pl-5 xl:hidden dark:border-gray-800 dark:bg-white/3">
